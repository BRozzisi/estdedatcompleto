 ...
 *                datos de la pila.
 * @param tope    - Entero que determina la posición en arreglo que actúa como
 *                el
 *                tope de la pila.
...
public class Pila {
    ...
    public String toString() {
        ...
        if (this.tope == -1) { // Si la pila está vacía devuelve "[]".
            ...
            cadena = "Tope --> [";
            for (i = this.tope; i >= 0; i--) { // Si la pila no está vacía recorre los elementos del tope hasta [0]
                                               // añadiendolos a una cadena.
