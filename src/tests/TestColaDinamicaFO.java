...
/**
 * <p>
 * Tests diseñados para realizar pruebas sobre una cola dinámica
 * </p>
 * 
 * @author Ochonga Franco - FAI 4638
 */

public class TestColaDinamicaFO {
    // *****************************************************************************
    //
    // Métodos auxiliares
    //
     ...
     */
    private void llenarCola(Cola cola, int cantElementos) {
    ...
    public void pruebaInsertarColaVacia() {
        ...
        assertEquals(c.toString().equals("Frente - [1] - Final"), true);
    ...
    public void pruebaToString() {
        ...
        boolean verificaIgualdad = contenido.equals("[1,2,3,4,5]");
        assertEquals(verificaIgualdad, true);
    }
